...
class GuessNumbers(models.Model):    # models의 Model 클래스 상속
    # 열 생성: CharField() 문자열, IntegerField() 정수형, DateTimeField() 날짜형...
    # 이러한 함수는 DB 유형에 상관없이 사용 가능 -> DB에 따라 맞춰준다.
